package hw5.ex3;
    ...
    public class EComController {
        public static void main( String [] args) {
            ...
            // Fixing the code to avoid chaining: Fix in Profile class
            customer.getProfile().setProfilesShippingCity("Kölle");
            customer.getProfile().setProfilesShippingZip(50939);
            customer.getProfile().setProfilesShippingCountry("Deutschland");

            System.out.println(" Shipping to: " + customer.getProfile().getProfilesShippingCity());
            System.out.println(" Shipping to: " + customer.getProfile().getProfilesShippingCountry());
            System.out.println(" Shipping to: " + customer.getProfile().getProfilesShippingZip());

            System.out.println("");
            System.out.println(" Customer ID:  " + customer.getId());
            System.out.println("");
            
            // Fixing the code to avoid chaining: Fix in Customer class
            customer.setCustomerShippingCity("Bornheim");
            customer.setCustomerShippingZip(52223);
            customer.setCustomerShippingCountry("Germany");

            System.out.println(" Shipping to: " + customer.getCustomerShippingCity());
            System.out.println(" Shipping to: " + customer.getCustomerShippingCountry());
            System.out.println(" Shipping to: " + customer.getCustomerShippingZip());
